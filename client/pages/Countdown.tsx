  ...
  const dailyMessages: DailyMessage[] = [
    {
      day: 1,
      message:
        "Good morning, beautiful! Today marks the beginning of our countdown to your special day. I can't wait to celebrate you! 🌅",
    ...
    },
    {
      day: 2,
      message:
        "Remember our first date? You wore that gorgeous smile that made my heart skip a beat. Still does every day! 💕",
      image: "/placeholder.svg",
    ...
    },
    {
      day: 3,
      message:
        "You have this amazing way of making ordinary moments feel extraordinary. Thank you for being you! 🌟",
      image: "/placeholder.svg",
    ...
    },
    {
      day: 4,
      message:
        "I love how you laugh at my silly jokes, even when they're not funny. Your laugh is my favorite sound! 😄",
      image: "/placeholder.svg",
    ...
    },
    {
      day: 5,
      message:
        "Every morning I wake up grateful that I get to love you and be loved by you. You're my sunshine! ☀️",
      image: "/placeholder.svg",
          ...
          {dailyMessages.map((day) => (
            ...
            >
              ...
              <div className="absolute top-2 left-2">
                <span
                  className={`font-playful font-bold text-sm ${day.unlocked ? "text-rose-600" : "text-gray-400"}`}
                >
                  {day.day}
                </span>
              </div>
